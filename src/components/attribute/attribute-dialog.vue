<template>
  ...
  >
    <el-form
      ...
      label-position="top"
    >
      <el-form-item label="Название атрибута" prop="title">
      ...
      <el-form-item label="Категория">
        <el-select v-model="data.category" placeholder="Выберите из списка">
          <el-option
      ...
      <el-form-item label="Фотография категории">
        <el-upload
          ...
          :action="`${url}/api/attribute/upload`"
...
const checkingSlug = async () => {
  ...
  lockToggle.value = await api.checkSlug('attribute', data.value.slug)
}
