<template>
  ...
  >
    ...
    >
      <el-row :gutter="30">
        <el-col :span="10">
          <el-form-item label="Название сервиса" prop="title">
      ...
      <el-form-item label="Подробный текст" class="editor">
        <QuillEditor theme="snow" v-model:content="data.text" ref="editortext" contentType="html" />
      </el-form-item>
    </el-form>
    <template #footer>
...
const checkingSlug = async () => {
  ...
  lockToggle.value = await api.checkSlug('service', data.value.slug)
}
