<template>
  ...
  <!-- <el-row :gutter="20">
    <el-col :span="6"><div class="grid-content ep-bg-purple" />sfdfsdf</el-col> 
    <el-col :span="6"><div class="grid-content ep-bg-purple" />dfsf</el-col>
    <el-col :span="6"><div class="grid-content ep-bg-purple" />dfdsfsdf</el-col>
    <el-col :span="6"><div class="grid-content ep-bg-purple" />cvxxghjtyjghf</el-col>
  </el-row> -->
</template>
